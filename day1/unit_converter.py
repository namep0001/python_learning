...
if(choice == 1):
    ...
    print(f"{number_to_convert} km is {miles_conv} mile.")
elif(choice == 2):
    print("2- miles to km.")
    km_conv = number_to_convert * 1.609344
    print(f"{number_to_convert} mile is {km_conv} km.")
elif(choice == 3):
    print("3- kg to lbs.")
    lbs_conv = number_to_convert * 2.2046226218
    print(f"{number_to_convert} kg is {lbs_conv} pound/lbs.")
elif(choice == 4):
    print("4- lbs to kg.")
    kg_conv = number_to_convert * 0.453592
    print(f"{number_to_convert} pound/lbs is {kg_conv} kg.")
elif(choice == 5):
    print("5- centimetre to inch.")
    inch_conv = number_to_convert * 0.3937007874
    print(f"{number_to_convert} centimetre is {inch_conv} inch.")
elif(choice == 6):
